...
export default function ContactCard() {
  ...
  useEffect(() => {
    setStatus(false);
    checkSkeleton(setSkeletonStatus);
  }, []);
      ...
      {skeletonStatus ? (
        <div className="flex flex-col justify-center items-center">
          ...
          >
            ...
            <p className=" text-green-600 font-montserrat-bold pr-2">
              Perfect!
            </p>
            <p>
...
function ContactCardSkeleton() {
  return (
    <>
      ...
      <div className="flex justify-center bg-white md:rounded-3xl shadow-lg  w-full md:w-1/3 mb-4 md:mb-6">
        <div className="p-6 flex flex-col gap-2">
          <Skeleton width={"18rem"} height={"2rem"} />
          <Skeleton width={"18rem"} height={"2rem"} />
          <Skeleton width={"18rem"} height={"2rem"} />
          <Skeleton width={"18rem"} height={"14rem"} />
        </div>
      </div>
    </>
  );
